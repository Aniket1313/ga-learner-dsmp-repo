...
acc_tfidf_nb=accuracy_score(nb_2.predict(X_test_count), Y_test)
...
# fit on count vectorizer training data
model1=logreg_1.fit(X_train_count,Y_train)

# fit on tfidf vectorizer training data
model2=logreg_2.fit(X_train_count,Y_train)
...
# accuracy with tfidf vectorizer
acc_tfidf_logreg=accuracy_score(logreg_2.predict(X_test_count), Y_test)
